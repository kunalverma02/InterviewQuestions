...
using SolveProblems.DynamicProgramming.PalindromicSubsequence;
    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // double asas =Convert.ToDouble(  3)/Convert.ToDouble(2);
            TestSolveLongestPalindromicSubsequenceDP();
            TestMinimumCoinChange();
            TestRodCutting();
        ...
        private static void TestSolveLongestPalindromicSubsequenceDP()
        {
            LongestPalindromicSubsequence lps = new LongestPalindromicSubsequence();
            Console.WriteLine(lps.SolveLongestPalindromicSubsequenceDP("abdbca"));
            Console.WriteLine(lps.SolveLongestPalindromicSubsequenceDP("cddpd"));
            Console.WriteLine(lps.SolveLongestPalindromicSubsequenceDP("pqr"));
            Console.WriteLine("-----------------------------------------------------------");
            Console.WriteLine(lps.SolveLongestPalindromicSubsequence("abdbca"));
            Console.WriteLine(lps.SolveLongestPalindromicSubsequence("cddpd"));
            Console.WriteLine(lps.SolveLongestPalindromicSubsequence("pqr"));
            //Console.WriteLine(ks.SolveMinimumCoinChange(coins, prices, 6));
        }
        private static void TestMinimumCoinChange()
        {
            MinimumCoinChange ks = new MinimumCoinChange();
            int[] coins = { 1, 5, 10, 25};
            Console.WriteLine(ks.SolveMinimumCoinChange(coins, 29));
            //Console.WriteLine(ks.SolveMinimumCoinChange(coins, prices, 6));
        }
